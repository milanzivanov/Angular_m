(function() {
	...
	// winesService servis je injektovan u WinesController
	var WinesController = function($scope, $log, winesService) {	
		...
		$scope.activePage = 1; // trenutno aktivna stranica, koristi se u tabeli za određivanje koja se vina prikazuje
