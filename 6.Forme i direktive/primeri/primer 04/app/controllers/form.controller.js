(function() {
	...
	function FormController() {
		...
		function reset() {
			...
			if(fc.stateForm.inputEmail.$invalid) {
				//na Reset želimo da se isprazni email ako nije validan
				fc.stateForm.inputEmail.$setViewValue('');
				fc.stateForm.inputEmail.$render();
			}
			fc.stateForm.$setUntouched();
		}
